...
fun AboutDialogContent() {
    ...
    Column(
        ...
        Text(
            text = "AMR VPN v${BuildConfig.VERSION_NAME}",
            style = MaterialTheme.typography.titleMedium
        )
        Text(
            text = "A free, source-available anti-censorship VPN tool designed to bypass internet restrictions. AMR VPN tunnels your traffic through DNS, SSH, Tor, and other protocols to keep you connected when access is blocked.",
